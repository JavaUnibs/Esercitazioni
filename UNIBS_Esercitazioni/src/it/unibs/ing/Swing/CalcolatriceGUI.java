...
public class CalcolatriceGUI {
	...
	private void initialize() {
		...
		btnCancel.setPreferredSize(new Dimension(52, 38));
		btnCancel.setMinimumSize(new Dimension(52, 38));
		btnCancel.setMaximumSize(new Dimension(52, 38));
		panel.add(btnCancel);
		...
		btnEqual.setPreferredSize(new Dimension(120, 38));
